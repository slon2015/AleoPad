...
function convertToPublicLaunchParams(
  ...
  return {
    ...
    is_cap_enabled: launch.flags.isCapEnabled.toString(),
    is_private_sells_enabled: launch.flags.isPrivateSellsEnabled.toString(),
    is_public_sells_enabled: launch.flags.isPublicSellsEnabled.toString(),
